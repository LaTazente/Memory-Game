...
public class Grille {
	/*
	 * Création de la classe Grille qui va modeliser le support des tuiles
	 */
	...
	/*
	 * Méthode qui va initialiser les 16 tuiles sur la grille le tableau cartes va
	 ...
	 * carrés arrondis après que les images soient retirés de la grille Aussi, le
	 ...
	 * seront doublés vu que tabtype est de taille 16 et elle renverra un tableau
	 */
	public int[] alea() {
	...
	/*
	 * Ici, on dessine les Tuiles à l'aide de la methode dessiner de la classe
	 ...
	 * contenant les coordonnées (x,y) dans la fenêtre. Par exemple,
	 * quelleCase(26,42) devra renvoyer 0,0, car les coordonnées (26,42) de la
	 * fenêtre appartiennent à la case(0,0) .
	 */
	...
	/*
	 * Une méthode void clicCase1(int x,int y) qui prend en paramètres les
	 * coordonnées d'un clic souris (dans le repère de la fenêtre), et remplit case1
	...
	/*
	 * Une méthode void clicCase2(int x,inty) qui prend en paramètres les
	 * coordonnées d'un clic souris (dans le repère de la fenêtre), et remplit case1
	 * avec les coordonnées de la case correspondante,et retourne la Tuile
	 */
	...
	public void clicCase2(int x, int y) {
		...
		// on verifie que l'emplacement du 2ème clic est différente de la première et
		// que
	...
	/*
	 * Ici on compare les deux cartes selectionées en fonction du type de la tuile ;
	...
	public void comparerCartes() throws InterruptedException {
		Thread.sleep(1000);/*
							 * Pour gérer le temps le temps après que deux cartes se soient retournées ici 1
							 * seconde
							 */
