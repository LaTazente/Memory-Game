...
public class Tuiles {
	...
	private int type; /*
						 ...
						 */
	private static Image imgdefault; // variable qui gère l'image par défaut
	private Image imagedeFace; // variable qui gère l'image de face
	private boolean retourner;// booleen qui controle si une tuile est retournée

	/* Constructeur avec paramètres qui va modeliser une tuile */
	...
	public Tuiles(int nbLignes, int nbColonne, int type) throws SlickException {
		...
		imgdefault = new Image("icons/def1.JPG"); /*
													 * attribution de l'image de dos présent dans le package "icons"
													 */

		/*
		 * J'utilise un switch case sur le type pour pouvoir attribuer à chaque tuile
	...
	/*
	 * methode pour dessiner chaque tuiles avec son image à un emplacement precis
